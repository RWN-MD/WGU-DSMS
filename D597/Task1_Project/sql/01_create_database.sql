...
CREATE DATABASE d597_task1;

-- Create the FitnessTrackers table
CREATE TABLE FitnessTrackers (
...
CREATE TABLE MedicalRecords (
    ...
    allergies VARCHAR(255),
    last_appointment_date DATE,
    tracker_reference VARCHAR(100) -- Will require cleanup to map to actual tracker_id
);

-- Create the bridging table
CREATE TABLE Patient_Tracker (
    patient_id INT,
    tracker_id INT,
    start_date DATE,
